...
export default function ShoppingCart({
  ...
  const hasInsufficientBalance = selectedStudent && cartItems.length > 0 && selectedStudent.balance < subtotal

  // Show insufficient balance toast when conditions are met
  useEffect(() => {
    if (hasInsufficientBalance) {
      const deficit = subtotal - selectedStudent!.balance
      toast.error(
  ...
  }, [hasInsufficientBalance, subtotal, selectedStudent])
