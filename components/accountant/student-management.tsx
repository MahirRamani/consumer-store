...
// import { Badge } from "@/components/ui/badge"
// import { Plus, Search, Edit, Download, UserPlus, Minus } from "lucide-react"
// import { toast } from "sonner"
// import AddStudentModal from "@/components/modals/add-student-modal"
// import TopUpModal from "@/components/modals/top-up-modal"
// import DeductBalanceModal from "@/components/modals/deduct-balance-modal"
...
//     queryKey: ["accountant-transactions", transactionFilter, startDate, endDate],
//     queryFn: async () => {
//       const params = new URLSearchParams({
//         page: "1",
//         limit: "50",
...
//       const response = await fetch(`/api/transactions/export?format=csv&${params}`)
//       if (!response.ok) throw new Error("Failed to export")
...
//   const getTransactionTypeBadge = (type: string, performedBy: string, amount: number) => {
//     const isPositive = type === "topup"
//     const color = isPositive ? "text-green-600" : "text-red-600"
//     const performedByColor = performedBy === "accountant" ? "text-purple-600" : "text-blue-600"
...
//         </span>
//         <span className={`text-xs ${performedByColor}`}>by {performedBy}</span>
//       </div>
//     )
//   }
...
//         <Card>
//           <CardHeader>
//             <CardTitle className="text-lg font-semibold text-gray-900">Students ({filteredStudents.length})</CardTitle>
//           </CardHeader>
//           <CardContent className="p-0">
//             {studentsLoading ? (
...
//                             </p>
//                             <p className="text-sm text-gray-500">Roll: {transaction.student?.rollNumber || "N/A"}</p>
//                           </div>
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap">
...
//             onSuccess={() => {
//               queryClient.invalidateQueries({ queryKey: ["students"] })
//               queryClient.invalidateQueries({ queryKey: ["accountant-transactions"] })
//             }}
//           />
//           <DeductBalanceModal
